...
var SiteToc = function SiteToc(_a) {
  ...
  return jsx("nav", __assign({
    ...
    children: sortNavGroupChildren(nav).map(function (n) {
      ...
      return jsxs("div", {
        children: [jsxs(Disclosure.Button, __assign({
          ...
          children: jsx(Disclosure.Panel, __assign({
            ...
            children: sortNavGroupChildren(item.children).map(function (subItem) {
              return jsx(NavComponent, {
                item: subItem,
                isActive: false
              });
...
var Footer = function Footer(_a) {
  ...
  return jsxs("footer", __assign({
    ...
    children: [jsx("div", __assign({
      ...
      children: ["Created by", jsxs("a", __assign({
        href: author.url,
        target: "_blank",
        rel: "noopener noreferrer",
      ...
      children: ["Made with", jsxs("a", __assign({
...
export { BlogsList as B, CustomLink as C, DocsLayout as D, EditThisPage as E, Hero as H, Layout as L, Mermaid as M, Nav as N, Pre as P, SearchProvider as S, TableOfContents as T, UnstyledLayout as U, __awaiter as _, __generator as a, __assign as b, __spreadArray as c, SimpleLayout as d, BlogLayout as e, formatDate as f, SiteToc as g, Comments as h, collectHeadings as i, defaultConfig as j, pageview as p, useTableOfContents as u };
